...
namespace TB_QuestGame
{
    ...
    public static class Text
    {
        ...
        {
            string messageBoxText =
                $"Very good then, we will call you {gameWonderer.Name} on this mission.\n" +
                " \n" +
        ...
        {
            string messageBoxText =
                $"{gameWonderer.Name}, it will be important for us to know your race on this mission.\n" +
                " \n" +
        ...
        {
            string messageBoxText =
                $"Very good then {gameWonderer.Name}.\n" +
                " \n" +
